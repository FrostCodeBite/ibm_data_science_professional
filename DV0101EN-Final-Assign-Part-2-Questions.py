...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        html.Label("Select Statistics:", style={'width':0.8, 'padding': '3px', 'font-size':'20px',"textAlign": "center"}),
        dcc.Dropdown(
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type and represent as a Bar chart      
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, 
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Average Number of Vehicale Sold by Vehicle Type"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(
                ...
                values='Advertising_Expenditure',
                names='Vehicle_Type',
                title='Total Expenditure Share by Vehicle Types in the year {}'.format(input_year)
            ))
